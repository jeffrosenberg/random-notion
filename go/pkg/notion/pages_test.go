...
const emptyCursor string = ""

func TestRetrievePagesWithBlankCursor(t *testing.T) {
	mockData := `{
		"object": "list",
		"results": [
				{
...
func TestRetrieveGetAllPages(t *testing.T) {
	mockData := `{
		"object": "list",
		"results": [
				{
...
func TestRetrievePagesStartingWithCursor(t *testing.T) {
	...
	ts, api := mockNotionServerWithPaging([]string{mockData1, mockData2}, http.StatusOK)
	defer ts.Close()
	pages, err := api.GetPages(mockCursor)
